...
<html>
	<head>
		...
		<title>Add Cards to Collection</title>
	...
	<body>
		...
		<div class = "container" id = "add_remove_form">
			...
			<h3> Add Cards to Collection </h3>
			<form:form method = "POST" action = "${pageContext.request.contextPath}/add_cards" modelAttribute = "card">
				<table>
					<tr>
