...
<html>
	...
	<body>
		...
		<!-- This section contains the form through which we will get the information used to search for cards in the database -->
		<div id = "search_form_div" class = "container">
			<h3>Search Collection</h3>
			<form:form method = "POST" action = "${pageContext.request.contextPath}/search_cards" modelAttribute = "card">
				<table>
					<tr>
