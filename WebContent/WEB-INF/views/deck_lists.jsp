...
<html>
	<head>
		...
		<title>View/Edit Deck Lists</title>
	...
	<body>
		...
		<div class = "container">
			<h3>Select a Deck List</h3>
			<form method = "POST">
				<select>
					<c:forEach items = "${allDecks}" var = "deck">
						<option value = "${deck.name}" label = "${deck.name}"/>
					</c:forEach>
				</select>
				<input type = "submit" value = "Submit">
			</form>
			<form action = "new_deck">
				<input type = "submit" name = "submit" value = "Create New Deck">
			</form>
			<form action = "home">
